...
stargazer(glm.1.1, header=F, title ="Interest in Science News by Religiosity", type = "html", out="arsenicinwells.html", out.header=TRUE)
stargazer(glm.1.1.2, header=F, title ="Reading Science News by Religiosity", type = "html", out="arsenicinwells.html", out.header=TRUE)
stargazer(glm.1.2, header=F, title ="Interest in Science News by Religiosity and Gender", type = "html", out="arsenicinwells.html", out.header=TRUE)
stargazer(glm.1.2.1, header = F, title = "Reading Science News by Religiosity and Gender", type = "html", out="arsenicinwells.html", out.header=TRUE)
stargazer(glm.1.5, header = F,  title = "Interest in Science News by Religiosity and Education", type = "html", out="arsenicinwells.html", out.header=TRUE)
stargazer(glm.1.5.1, header = F, title = "Reading Science News by Religiosity and Education", type = "html", out="arsenicinwells.html", out.header=TRUE)
stargazer(glm.1.3, header = F, title = "Interest in Science News by Religiosity and Ethnicity", type = "html", out="arsenicinwells.html", out.header=TRUE)
stargazer(glm.1.4, header = F,  title = "Interest in Science News by Religiosity and Region", type = "html", out="arsenicinwells.html", out.header=TRUE)
stargazer(glm.2.1, header = F,  title = "Interest in Science News by Party Affiliation", type = "html", out="arsenicinwells.html", out.header=TRUE)
stargazer(glm.2.1.1, header = F,  title = "Frequency of Reading Science News by Party Affiliation", type = "html", out="arsenicinwells.html", out.header=TRUE)
stargazer(lm.3.1, header = F, title = "Social Media Science News Engagement by Region", type = "html", out="arsenicinwells.html", out.header=TRUE)
stargazer(lm.3.2, header = F, title = "Social Media Science News Engagement by Gender", type = "html", out="arsenicinwells.html", out.header=TRUE)
stargazer(lm.3.3, header = F, title = "Social Media Science News Engagement by Religiosity", type = "html", out="arsenicinwells.html", out.header=TRUE)
stargazer(lm.3.4, header = F, title = "Social Media Science News Engagement by Party Affiliation", type = "html", out="arsenicinwells.html", out.header=TRUE)
stargazer(lm.3.5, header = F, title = "Social Media Science News Engagement by Education", type = "html", out="arsenicinwells.html", out.header=TRUE)
stargazer(lm.3.6, header = F, title = "Social Media Science News Engagement by Age Category", type = "html", out="arsenicinwells.html", out.header=TRUE)
