...
```{r, echo = FALSE, results = 'asis'}
stargazer(glm.1.1, header=F, title ="Interest in Science News by Religiosity")
stargazer(glm.1.1.2, header=F, title ="Reading Science News by Religiosity")
stargazer(glm.1.2, header=F, title ="Interest in Science News by Religiosity and Gender")
stargazer(glm.1.2.1, header = F, title = "Reading Science News by Religiosity and Gender")
stargazer(glm.1.5, header = F,  title = "Interest in Science News by Religiosity and Education")
stargazer(glm.1.5.1, header = F, title = "Reading Science News by Religiosity and Education")
stargazer(glm.1.3, header = F, title = "Interest in Science News by Religiosity and Ethnicity")
stargazer(glm.1.4, header = F,  title = "Interest in Science News by Religiosity and Region")
stargazer(glm.2.1, header = F,  title = "Interest in Science News by Party Affiliation")
stargazer(glm.2.1.1, header = F,  title = "Frequency of Reading Science News by Party Affiliation")
stargazer(lm.3.1, header = F, title = "Social Media Science News Engagement by Region")
stargazer(lm.3.2, header = F, title = "Social Media Science News Engagement by Gender")
stargazer(lm.3.3, header = F, title = "Social Media Science News Engagement by Religiosity")
stargazer(lm.3.4, header = F, title = "Social Media Science News Engagement by Party Affiliation")
stargazer(lm.3.5, header = F, title = "Social Media Science News Engagement by Education")
stargazer(lm.3.6, header = F, title = "Social Media Science News Engagement by Age Category")
